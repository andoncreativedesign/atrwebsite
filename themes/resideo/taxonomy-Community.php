...
<script>
    jQuery(document).ready(function(){
        jQuery(".group").colorbox({rel:'group', transition:"fade", maxWidth:'95%', maxHeight:'95%'});
    });
</script>
<style type="text/css">
    ...
    if (get_locale()=='ar') {
        ...
        .pxp-props-carousel-right-arrow{right: unset !important; left: 0px;}
        <?php
    }
                        ...
                        <div class="container">
                            ...
                            <div class="pxp-services-h-container mt-4 mt-md-5" style="margin-top:0px !important;">
                                <div class="pxp-services-h-items pxp-animate-in mt-4 mt-md-5 mt-lg-0 pxp-in <?php echo (get_locale() == 'ar' ? '' : 'ml-0 mr-lg-5'); ?>" style="min-height: 284px">
                                    ...
                                    <h3 class="pxp-section-h2" style="color: ">
            ...
            if( $s%2 == 0 ) { ?>
                <div class="pt-100 pb-100 page_service_community body_color" style=" padding-bottom: 70px;">
                    <div class="container">
                        ...
                        <script>
                            jQuery(document).ready(function(){
                                jQuery(".group<?php echo $s; ?>").colorbox({rel:'group<?php echo $s; ?>', transition:"fade", maxWidth:'95%', maxHeight:'95%'});
                            });
                        </script>
