(function($) {
    ...
    elementLoaded('#dsidx.dsidx-results #dsidx-map-control a', function(el) {
        ...
        if ($('.pxp-idx-map-half').length > 0) {
            ...
            $('.dsidx-sorting-control').after('<a role="button" class="pxp-idx-map-toggle">'+
                '<img src="https://wordpress-823234-2829680.cloudwaysapps.com/wp-content/themes/resideo/images/ic_map_24px.png"></a>');
    ...
    if ($('.dsidx-show-hide-map').length > 0) {
        ...
        if ($('.pxp-idx-map-half').length > 0) {
            ...
            $('.dsidx-sorting-control').after('<a role="button" class="pxp-idx-map-toggle"><img src="https://wordpress-823234-2829680.cloudwaysapps.com/wp-content/themes/resideo/images/ic_map_24px.png"></a>');
