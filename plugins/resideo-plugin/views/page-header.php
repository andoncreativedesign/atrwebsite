                    ...
                    <div class="pxp-hero vh-100">
                        ...
                        <?php } else { 
                            ...
                            if ($slider_type == "video") {
                                ...
                                <div class="ct_home_logo_cont"><img src="<?php echo get_field('ct_home_logo_image');?>" width="199" height="116" alt="Al Tahaluf - The best Real Estate company in Saudi Arabia"></div>
