    ...
    function resideo_get_filter_properties_form_sidebar() {
        ...
        <div class="pxp-side-section pxp-side-section-filter-form mt-4 mt-md-5">
            <form class="pxp-results-filter-form" role="search" method="get" action="<?php echo esc_url($search_submit); ?>">
                ...
                <h3><?php 
                    icl_register_string("resideo", 'Filter results','Filter results');
                    echo pll__('Filter results'); 
                ?></h3>
                ...
                if ($address_f == 'yes') { ?>
                        <?php if($address_type == 'auto') { ?>
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control pxp-is-address property_city_search" id="filter-address-auto" name="search_address" autocomplete="off" value="<?php echo esc_attr($search_address); ?>">
                                <input type="hidden" id="city_term_id" name="city_term_id" value="">
                        ...
                        <?php } else { ?>
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control pxp-is-address property_city_search" id="search_address" name="search_address" value="<?php echo esc_attr($search_address); ?>">
                                <input type="hidden" id="city_term_id" name="city_term_id" value="">
                            </div>
                        <?php } ?>
                <?php } ?>
