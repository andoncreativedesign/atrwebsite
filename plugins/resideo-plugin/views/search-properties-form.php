                ...
                <div class="<?php echo esc_attr($column_class); ?>">
                    <div class="form-group">
                        <?php if($address_type == 'auto') { ?>
                            <input type="text" class="form-control property_city_search" id="hero-search-address-auto" name="search_address" placeholder="<?php esc_attr_e('Enter address...', 'resideo'); ?>" autocomplete="off">
                        ...
                        <?php } else { ?>
                            <input type="text" class="form-control property_city_search" id="search_address" name="search_address" placeholder="<?php esc_attr_e('Enter address...', 'resideo'); ?>">
                            <input type="hidden" id="city_term_id" name="city_term_id" value="">
                        <?php } ?>
                    </div>
                </div>
