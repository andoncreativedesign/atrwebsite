        ...
        if (isset($instance['address']) &&  $instance['address'] == '1') {
            ...
            if ($address_type == 'auto') {
                $search_fields .= '
                    ...
                    <input type="text" class="form-control property_city_search" id="widget-search-address-auto" name="search_address" autocomplete="off">
                ...
                $search_fields .= '
                    ...
                    <input type="text" class="form-control property_city_search" id="search_address" name="search_address">
                    <input type="hidden" id="city_term_id" name="city_term_id" value="">
                    ';
            }
            $search_fields .= '
