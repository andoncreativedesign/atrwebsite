...
class Resideo_Recent_Properties_Widget extends WP_Widget {
    function __construct() {
        $widget_ops  = array('classname' => 'resideo_recent_properties_sidebar', 'description' => __('Recently listed properties', 'resideo'));
        $control_ops = array('id_base' => 'resideo_recent_properties_widget');

        parent::__construct('resideo_recent_properties_widget', __('Resideo Recently Listed Properties', 'resideo'), $widget_ops, $control_ops);
    }
    ...
    function update($new_instance, $old_instance) {
        ...
        if (function_exists('icl_register_string')) {
            icl_register_string('resideo_recent_properties_widget', 'resideo_recent_properties_widget_title', sanitize_text_field($new_instance['title']));
            icl_register_string('resideo_recent_properties_widget', 'resideo_recent_properties_widget_limit', sanitize_text_field($new_instance['limit']));
            icl_register_string('resideo_recent_properties_widget', 'resideo_recent_properties_widget_type', sanitize_text_field($new_instance['type']));
            icl_register_string('resideo_recent_properties_widget', 'resideo_recent_properties_widget_status', sanitize_text_field($new_instance['status']));
        }
