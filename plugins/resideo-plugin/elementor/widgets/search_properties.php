    ...
    protected function render() {
        ...
        if ($settings['address'] == '1') {
            ...
            if ($address_type == 'auto') {
                $address_field .= 
                        '<input type="text" class="form-control pxp-is-address property_city_search" id="filter-address-auto" name="search_address" placeholder="' . __('Search by City, Neighborhood, or Address', 'resideo') . '" autocomplete="off">
                ...
                $address_field .= 
                        '<input type="text" class="form-control pxp-is-address property_city_search" id="search_address" name="search_address" placeholder="'.pll__('Search...').'">
                        <input type="hidden" id="city_term_id" name="city_term_id" value="">
                        ';
            }
            $address_field .= 
