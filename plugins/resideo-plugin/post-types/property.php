...
if (!function_exists('resideo_add_property_metaboxes')): 
    function resideo_add_property_metaboxes() {
        ...
        add_meta_box('property-gallery-section', __('Interior Photo Gallery', 'resideo'), 'resideo_property_gallery_render', 'property', 'normal', 'default');
                ...
                <tr>
                    ...
                    <td width="40%" valign="top">
                        <div class="adminField">
                            ...
                            $resideo_p_neighborhood_t_field = esc_attr(get_post_meta($post->ID, 'resideo_p_neighborhood_t_field', true));
...
/*
                          ...
                          /*  if ($neighborhood_type == 'list') {
                                ...
                                print '<input type="text" class="formInput" id="neighborhood" name="neighborhood33" placeholder="' . __('Enter neighborhood', 'resideo') . '" value="' . esc_attr(get_post_meta($post->ID, 'neighborhood33', true)) . '" />';
                            //}
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                    <td width="40%" valign="top">
                        <div class="adminField">
                            <label for="locality33">' . __('City', 'resideo') . '</label><br />';
                            ...
                            if ($city_type == 'list') {
                                ...
                                print '<select id="locality33" name="locality33" class="formInput">
                                            ...
                                            if (is_array($resideo_cities_settings) && count($resideo_cities_settings) > 0) {
                                                ...
                                                foreach ($resideo_cities_settings as $key => $value) {
                                                    print '<option value="' . $key . '"';
                                                    if (get_post_meta($post->ID, 'locality33', true) == $key) {
                                                        print ' selected ';
                                                    }
                                                    print '>' . $value['name'] . '</option>';
                                                }
                                ...
                                print '<input type="text" class="formInput" id="locality33" name="locality33" placeholder="' . __('Enter city', 'resideo') . '" value="' . esc_attr(get_post_meta($post->ID, 'locality33', true)) . '" />';
                            }
                    ...
                    <td width="40%" valign="top">
                        <div class="adminField">
                            <label for="administrative_area_level_11">' . __('County/State', 'resideo') . '</label><br />
                            <input type="text" class="formInput" id="administrative_area_level_11" name="administrative_area_level_11" placeholder="' . __('Enter county/state', 'resideo') . '" value="' . esc_attr(get_post_meta($post->ID, 'administrative_area_level_11', true)) . '" />
                        </div>
                    </td>
                    <td width="20%" valign="top">
                        <div class="adminField">
...
if (!function_exists('resideo_property_meta_save')): 
    function resideo_property_meta_save($post_id) {
        ...
        if (isset($_POST['neighborhood33'])) {
            update_post_meta($post_id, 'neighborhood33',$_POST['neighborhood33']);
        }
        if (isset($_POST['locality33'])) {
            update_post_meta($post_id, 'locality33', sanitize_text_field($_POST['locality33']));
        }
        if (isset($_POST['administrative_area_level_11'])) {
            update_post_meta($post_id, 'administrative_area_level_11', sanitize_text_field($_POST['administrative_area_level_11']));
        }
