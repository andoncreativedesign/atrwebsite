      ...
      /*  print "====================================";
        ...
        switch($s_array['layout']) {
            ...
            case '2':
                ...
                if ($s_array['subtitle'] != '') {
                    $return_string .= '
                            <h2 class="pxp-section-featured-h2 heading_style_arabic">' . esc_html($s_array['subtitle']) . '</h2>';
                }
                if ($s_array['cta_label'] != '' && $s_array['cta_link'] != '') {
                    $return_string .= '
        ...
        foreach($posts as $post) : 
            ...
            $return_string .= '
                        ...
                        <div class="pxp-prop-card-1-details-cta text-uppercase">'.pll__('View Details').'</div>
                    </a>
                </div>';
        endforeach;
