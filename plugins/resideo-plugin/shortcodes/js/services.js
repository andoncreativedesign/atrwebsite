    ...
    tinymce.PluginManager.add('res_services', function(editor, url) {
        ...
        function openShortcodeModal(obj) {
                                    ...
                                    '<div style="padding: 20px;">' + 
                                        ...
                                        '<div class="row">' + 
                                            '<div class="col-xs-12 col-md-12 rtl-pull-right">' + 
                                                '<div class="form-group">' + 
                                                    '<label for="sh-services-youtube">Youtube</label>' + 
                                                    '<textarea type="text" id="sh-services-youtube" class="form-control" placeholder="Enter Youtube Link.">' + getObjectProperty(short, "youtube") + '</textarea>' + 
                                                '</div>'+ 
                                            '</div>'+  
                                        '</div>' + 
                                        '<div class="row">' + 
            ...
            modalContent += 
                                        ...
                                        '</div>' + 
                                        '<div class="row">' + 
                                            '<div class="col-md-12" style="' + cta_style + '">' + 
                                                    '<label for="cta_sevice_text">Service Text</label>' + 
                                                    '<textarea style="height:100px;" type="text" id="cta_sevice_text" class="form-control" >' + 
                                                    getObjectProperty(short, "cta_sevice_text") + '</textarea>' 
                                                    + 
                                            '</div>'+ 
                                        '</div>'+ 
                                        '<div class="row">' + 
            ...
            $('#shortcode-modal #insert-button').on('click', function(e) {
                var shortVal = {
                    ...
                    'cta_sevice_text':$('#cta_sevice_text').val(),
                    'cta_color' : $('#sh-services-cta-color').val(),
                    'youtube' : $('#sh-services-youtube').val(),
                    'services'  : services,
                }
        ...
        editor.addButton('res_services', {
            ...
            onclick: function() {
                editor.execCommand('res_services_panel_popup', '', {
                    data_content: '{ "title": "", "subtitle": "", "youtube": "", "image": "", "image_src": "", "layout": "1", "margin": "no", "display": "columns", "text_color": "", "cta_label": "", "cta_link": "", "cta_color": "", "services": [] }',
                });
            }
        });
