        ...
        function openShortcodeModal(obj) {
                                ...
                                '<div class="media-frame-content">' + 
                                    '<div style="padding: 20px;" id="sh-recent-properties">' + 
                                        ...
                                        '<div class="row">' + 
                                            '<div class="col-xs-12 col-md-4 rtl-pull-right">' + 
                                                '<div class="form-group">' + 
                                                    '<label for="sh-recent-properties-style">Style</label>' + 
                                                    '<select id="sh-recent-properties-style" class="form-control">';
           
                modalContent += '<option value="old"';
                                                    if (getObjectProperty(short, "style") == 'old') {
                    modalContent += ' selected="selected"';
                }

                      modalContent += '>Old</option>' + 
            ...
            $('#shortcode-modal #insert-button').on('click', function(e) {
                var shortVal = {
                    ...
                    'style'    : $('#sh-recent-properties-style').val(),
