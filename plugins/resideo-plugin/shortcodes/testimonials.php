                ...
                $return_string = 
                    '<div class="pxp-testim-1 pt-100 pb-100 pxp-cover" style="background-image: url(' . esc_url($photo_src) . ');">
                        <div class="pxp-testim-1-intro">
                            <p class="pxp-text-light" style="' . esc_attr($text_color) . '; color: #4D858D !important; font-weight: 700;">' . esc_html($s_array['title']) . '</p>
                            <h3 class="pxp-section-h2" style="' . esc_attr($text_color) . 'black;">' . esc_html($s_array['subtitle']) . '</h3>';
            }
            else{
                $return_string = 
                    '<div class="pxp-testim-1 pt-100 pb-100 mt-100 pxp-cover" style="background-image: url(' . esc_url($photo_src) . ');">
                        <div class="pxp-testim-1-intro">
