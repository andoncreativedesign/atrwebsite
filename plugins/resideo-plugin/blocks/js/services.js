(function(wp) {
    ...
    function ServicesControl(props) {
        ...
        var display    = getObjectProperty(data_json, 'display');
        ...
        var onNewIconClick = function(event) {
            var target = jQuery(event.target);
            var iconClass = target.hasClass('services-icons-item') ? target.text().trim() : target.parent().text().trim();
        ...
        var onNewBgImageSelect = function(media) {
            setState({
                newBgImageSrc: media.url,
                newBgImageId: media.id
            });
        };

        var renderFaIconsList = function() {
            var list = [];

            for (var i = 0; i < faIcons.length; i++) {
                list.push(el('div', 
                    {
                        className: 'col-xs-12 col-sm-6 col-md-4 is-icon'
                    },
                    el('div', 
                        {
                            className: 'services-icons-item',
                            onClick: (event) => {
                                onNewIconClick(event);
                            }
                        },
                        el('span', 
                            {
        ...
        var renderIconsModal = isOpen ? el(Modal, 
            {
                title: __('Services Icons', 'resideo'),
                className: 'pxp-services-icons-modal',
            ...
            el('div', 
                {
                    className: 'services-icons-modal-search'
                },
                el('div', 
                    {
                        className: 'icons-search-field'
                    },
                    el('span', 
                        {
                    ...
                    el(TextControl, 
                        {
                            placeholder: __('Search icons...', 'resideo'),
                            onChange: function(value) {
                                jQuery('.is-icon').each(function(index) {
        ...
        var renderColorSelector = (newIcon != '') ? el('div',
            {
                    ...
                    el('legend',
                        ...
                        el('div',
                            ...
                            el('span',
                                ...
                                __('Service Icon Color', 'resideo'),
                            )
                        )
                    ),
                    el(ColorPalette,
                        {
                            className: 'services-list-new-color',
                            label: __('Service CTA Label', 'resideo'),
                            value: newColor,
                            colors: [
                    ...
                    el('legend',
                        ...
                        el('div',
                            ...
                            el('span',
                                ...
                                __('Service CTA Color', 'resideo'),
                            )
                        )
                    ),
                    el(ColorPalette,
                        {
                            className: 'services-list-new-cta-color',
                            label: __('Service CTA Label', 'resideo'),
                            value: newCTAColor,
                            colors: [
                                { name: 'Pale pink', color: '#f58fa8' },
        ...
        var renderMainCTAColorSelector = el('div',
            {
                className: 'components-base-control'
            },
            el('div',
        ...
        var renderServicesListItemImg = function(item) {
            return item.isicon != '1' ? el('div',
                {
                ...
                {
                    className: 'services-list-item-icon',
                },
                el('span',
                    {
                        ...
                        el('li',
                            ...
                            el('div',
                                ...
                                el('div',
                                    ...
                                    renderServicesListItemImg(elem)
                                ),
                                el('div',
                                    {
                                        className: 'col-xs-8'
        ...
        var servicesOptions = [
                        ...
                        el(SelectControl, 
                            {
                                ...
                                value: display,
                                options: [
                                    { label: __('Columns', 'resideo'), value: 'columns' },
                                    { label: __('Grid', 'resideo'), value: 'grid' }
                                ],
                                onChange: function(value) {
                                    data_json.display = value;
                                    setAttributes({ data_content: encodeURIComponent(JSON.stringify(data_json)) });
                                }
                            }
                        ),
                    ...
                    el(SelectControl, 
                        {
                            ...
                            options: [
                                ...
                                { label: __('Layout 4', 'resideo'), value: '4' },
                                { label: __('Layout 5', 'resideo'), value: '5' },
                                { label: __('Layout 6', 'resideo'), value: '6' },
                                { label: __('Layout 7', 'resideo'), value: '7' }
                            ],
                            onChange: function(value) {
                ...
                el('div',
                    {
                        className: 'col-xs-12 col-sm-6',
                        style: {
                            display: (layout == 4 || layout == 6 || layout == 7) ? 'none' : 'block'
                        }
                    },
                    el(MediaUpload,
                        {
                            onSelect: function(media) {
                                jQuery('.pxp-block-services-bg-image-btn')
                            ...
                            render: function(obj) {
                                return el(Button,
                                    {
                                        className: 'pxp-block-services-bg-image-btn',
                                        'data-src': image_src,
                                        'data-id': image,
                                        style: {
            ...
            el('div',
                {
                    className: 'row',
                    style: {
                        display: (layout == 1 || layout == 4 || layout == 6 || layout == 7) ? 'none' : 'block'
                    },
                },
                el('div',
                    {
            ...
            el('div',
                ...
                renderMainCTAColorSelector
            ),
            el('h4', 
                {
                    className: 'services-list-header'
                },
                __('Services List', 'resideo')
            ),
            el('div',
                {
            ...
            el('div',
                ...
                el('div',
                    ...
                    el('div',
                        ...
                        el('div',
                            {
                                className: 'services-list-new-image-placeholder',
                                style: {
                                        ...
                                        return el(Button,
                                            {
                                                isSecondary: true,
                                                isSmall: true,
                                                className: 'services-list-new-image-btn',
                                                onClick: obj.open
                                            },
                            ...
                            el(Button,
                                {
                                    isSecondary: true,
                                    isSmall: true,
                                    className: 'services-list-new-icon-btn',
                                    onClick: function() {
                                    ...
                                    return el(Button,
                                        {
                                            ...
                                            style: {
                                                backgroundImage: newBgImageSrc != '' ? 'url(' + newBgImageSrc + ')' : 'none',
                                                marginTop: '20px'
                                            },
                                            onClick: obj.open
                                        },
                        ...
                        el(TextControl, 
                            {
                                ...
                                label: __('Service Title', 'resideo'),
                                value: newTitle,
                                placeholder: __('Enter service title', 'resideo'),
                        ...
                        el(TextControl, 
                            {
                                ...
                                label: __('Service CTA Label', 'resideo'),
                                value: newLabel,
                                placeholder: __('Enter service CTA label', 'resideo'),
                ...
                el(Button,
                    {
                        ...
                        onClick: function() {
                            services.push({
                                'src': newImageSrc,
                                'isicon': newIcon != '' ? '1' : '',
                                'value': newIcon != '' ? newIcon : newImageId,
                                'bgsrc': newBgImageSrc,
                                'bgvalue': newBgImageId,
                                'title': newTitle,
                                'text': newText,
                                'link': newLink,
                                'cta': newLabel,
    ...
    registerBlockType('resideo-plugin/services', {
        title: __('Services', 'resideo'),
        description: __('Resideo services block.', 'resideo'),
        icon: {
            src: 'portfolio',
            foreground: '#007cba',
        },
        ...
        attributes: {
            data_content: {
                type: 'string',
                default: '%7B%22title%22%3A%22%22%2C%22subtitle%22%3A%22%22%2C%22image%22%3A%22%22%2C%22image_src%22%3A%22%22%2C%22layout%22%3A%221%22%2C%22margin%22%3A%22no%22%2C%22display%22%3A%22columns%22%2C%22text_color%22%3A%22%22%2C%22cta_label%22%3A%22%22%2C%22cta_link%22%3A%22%22%2C%22cta_color%22%3A%22%22%2C%22services%22%3A%5B%5D%7D'
            }
        },
        edit: withState({
            isOpen: false, 
